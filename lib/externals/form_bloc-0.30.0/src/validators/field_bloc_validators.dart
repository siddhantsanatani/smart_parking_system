...
class FieldBlocValidatorsErrors {
  ...
  static const String email = 'Email ID not in valid format yet';
  ...
  static const String number = 'Enter a valid number';
}
...
class FieldBlocValidators {
  ...
  static String? number(String? string) {
    final numRegExp =
        RegExp(r'^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6-9]\d{9}$');
    if (string == null || string.isEmpty || numRegExp.hasMatch(string)) {
      return null;
    }
